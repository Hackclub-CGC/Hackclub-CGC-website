...
<!-- Navbar -->
 ...
 <img src="Img/asset_2.png" height="80px">
  ...
  <footer class="page-footer font-small blue-grey lighten-5 mt-5">
    ...
    <div class="row  dark-grey-text">
        ...
        <div class="col-6 col-lg-4 mb-4 footer-useful-pg display-pc ">
          ...
          <p>
            ...
            <i class="fas fa-envelope mr-3" style="font-size: 20px !important;"></i>services@hackclubcgc.tech</a>
            </p>
        </div>
        <!-- Grid column -->
    ...
    <div style="text-align: center; font-size: 10px;">&copy; 2020 Hack Club CGC</div>
    <br>
    <!-- Grid column -->
    <!-- Copyright -->
    <!-- Copyright -->
